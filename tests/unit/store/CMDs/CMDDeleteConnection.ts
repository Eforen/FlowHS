...
export const tests_CMDDeleteConnection = () => {
    describe('CMD: CMDDeleteConnection', () => {
        ...
        it('Do/Undo', () => {
            let cmd = new CMDDeleteConnection("3e6cd641-ea9c-48ca-8229-364433797152") //Was e1a2381b-35d0-4155-8659-a53e88e0600e
