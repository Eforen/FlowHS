(function (global, factory) {
	...
	(factory((global.D3NE = global.D3NE || {})));
...
var template$2 = function (locals) {
  var pug_html = "",
    ...
    pug_html = pug_html + "<div class=\"node {{editor.selected.contains(node)?'selected':''}} {{node.title.toLowerCase().replace('/ /g','-')}}\" al-repeat=\"node in editor.nodes\" :style.transform=\"&quot;translate(&quot;+node.position[0]+&quot;px,&quot;+node.position[1]+&quot;px)&quot;\" al-node :data-id=\"node.id\">";
